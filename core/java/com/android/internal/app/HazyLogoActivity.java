...
public class HazyLogoActivity extends Activity {
    FrameLayout mContent;
    int mCount;
    final Handler mHandler = new Handler();
    static final int BGCOLOR = 0xff33b9f2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logo.setImageResource(com.android.internal.R.drawable.hazylogo);
        ...
        String hazyversion = SystemProperties.get("ro.hazy.version");
            ...
            public boolean onLongClick(View v) {
                ...
                try {
                    startActivity(new Intent(Intent.ACTION_MAIN)
                        ...
                        .addCategory("com.android.internal.category.HAZYLOGO"));
                } catch (ActivityNotFoundException ex) {
                    android.util.Log.e("HazyLogoActivity", "Couldn't catch a break.");
                }
                finish();
                return true;
            }
